...
export const allBuildings: Building[] = [
  ...
  },
  {
    ...
    category: 'Mining',
    description:
      'This mine can be harvested 3 times. It will bring you rocks, metal and coal. You need to have 3 frens available to harvest this mine.',
    level: 0,
    daily_cost: [
      {
        level: 1,
  ...
  },
  {
    ...
    category: 'Security',
    description:
      'Police station make your community more secure. You need to build a police station for every 20 buildings built in your community.',
    level: 6,
    cost_update: [
      {
        level: 1,
  ...
  },
  {
    ...
    category: 'Resource',
    description:
      'Bushes can be harvested 3 times. Bushes bring food. You need to have one fren available to harvest a bush.',
    level: 0,
    daily_cost: [
      {
        level: 1,

...
export const allAchievements: Achievement[] = [
    {
        ...
        description: "Welcome to Frens Lands ! We'll walk you through the first steps to play this pre-alpha version. If you don't want to see these updates in the future you can disable them by clicking on the checkbox on the top right side of your screen.",
        unlock: []
    },
    {
        level: 2,
    ...
    },
    {
        ...
        description: "You built your first farm ! Your farm is fueled for the next 5 blocks. It will bring you 5 food every block. Once the 5 blocks passed you can fuel your farm so it continues producing more food.",
        unlock: [21]
    },
    {
        level: 4,
        goal: "Build some shops",
        goalDesc: "Your frens go a long way out of your community to buy basic products, build a grocery shop & a bakery",
        description: "You can now produce energy! Your coal plant is recharged for the next 5 blocks then you can fuel it. It will bring you 2 energy / block.",
        unlock: [7, 8, 18, 19]
    },
    {
        level: 5,
        goal: "Build a bar and a restaurant.",
        goalDesc: "Your frens are bored on weekends, you should build a place for them to relax and socialize ... ",
    ...
    },
    {
        ...
        goalDesc: "Build all the existing buildings available in your world. Many more will come soon !",
        description: "",

        ...
        <div className="bg-home docsPage selectDisable">
          ...
          <div className="flex flex-col justify-center">
            ...
            <a
              ...
              rel="noreferrer"
            >
              <div className="notionIcon pixelated"></div>
            </a>

            <div className="whitepaperIcon text-center mx-auto pixelated"></div>

            <a
              href="https://github.com/FrensLands"
              target="_blank"
              className="text-center mx-auto"
              rel="noreferrer"
            >
              <div className="gitIcon pixelated"></div>
            </a>
            ...
            <div className="grid md:grid-cols-3">
              <div className="flex flex-col justify-center text-white pressKitElem md:mb-1 mb-5">
                ...
                <p className="mx-auto text-center text-fl-grey fontHpxl_JuicyXL md:mb-3 mb-2">
                  BANNERS
                </p>
                <a
                  href="https://drive.google.com/file/d/1fl0GTmISq-cfJHpjT4zipHNpFMVAjGqt/view?usp=sharing"
                  target="_blank"
                  className="mx-auto text-center"
                  rel="noreferrer"
                >
                  <p className="fontHPxl-sm">400 x 160</p>
                </a>
                <a
                  href="https://drive.google.com/file/d/1n3J9XTyCJXKO1dUB6ZQC1qFgpma61eA2/view?usp=sharing"
                  target="_blank"
                  className="mx-auto text-center"
                  rel="noreferrer"
                >
                  <p className="fontHPxl-sm">1220 x 208</p>
                </a>
              </div>
              ...
              <div className="flex flex-col justify-center text-white pressKitElem md:mb-1 mb-5">
                ...
                <a
                  href="https://drive.google.com/file/d/1Iv6CA4k_FgBcqTZtWNCqf-qv9vEZ2aEe/view?usp=sharing"
                  target="_blank"
                  className="mx-auto text-center"
                  rel="noreferrer"
                >
                  <p className="fontHPxl-sm">Small : 120 x 120</p>
                </a>
                <a
                  href="https://drive.google.com/file/d/1mUot9wqSYe7KfQmdQDzo0VeA0lm7zH1D/view?usp=sharing"
                  target="_blank"
                  className="mx-auto text-center"
                  rel="noreferrer"
                >
                  <p className="fontHPxl-sm">Large: 400 x 400</p>
                </a>
              </div>
              ...
              <div className="flex flex-col text-white pressKitElem md:mb-1 mb-5">
                ...
                <p
                  className="fontHPxl-sm mx-auto text-center cursor-pointer"

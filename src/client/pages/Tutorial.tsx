          ...
          <div className="flex flex-col justify-center xl:w-[1080px] mx-auto">
            ...
            <div className="grid md:grid-cols-3 my-5">
              <div className="flex flex-col justify-center mb-10">
                ...
                <div className="team-desc fontHPxl-sm text-fl-yellow mx-auto text-justify w-2/3">
                  Chop trees and break rocks to gather resources to build from.
                </div>
              </div>
              <div className="flex flex-col justify-center mb-10">
                <img
                ...
                <div className="team-desc fontHPxl-sm text-fl-yellow mx-auto text-justify w-2/3">
                  Create various buildings and unlock many more ! Each buildings
                  will have a purpose in your lands.
                </div>
              </div>
              <div className="flex flex-col justify-center mb-10">
                <img
                ...
                <div className="team-desc fontHPxl-sm text-fl-yellow mx-auto text-justify w-2/3">
                  You can claim the resources produced by your buildings to
                  progress even more.
                </div>
              </div>
            </div>
            ...
            <div className="md:flex mx-auto justify-center">
              ...
              >
                <a
                  ...
                  rel="noreferrer"
                >
                  <div className="discordIcon-square mx-auto text-center"></div>
                </a>
              </div>
            ...
            <div className="md:flex mx-auto justify-center">
              ...
              >
                ...
                <a href="https://braavos.app/" target="_blank" rel="noreferrer">
            ...
            <div className="md:flex mx-auto justify-center">
              ...
              <p className="fontHPxl-sm text-white md:w-2/3 mx-2 md:mt-3 md:mr-10 text-justify">
                - You need to own a land NFT to be able to play the game. While
                we're on testnet we'll give a free land to every playtester.
                Follow the discord to stay informed about the upcoming testing
                sessions.
              </p>
            </div>
            ...
            <p className="text-center fontHPxl-sm text-fl-light-blue md:w-1/2 mx-auto mt-10 mb-5">
              Frens Lands is currently in pre-alpha on StarkNet testnet. This
              first version was built during the Matchbox hackathon beginning of
              July and polished through August. The contracts, costs of
              buildings are subject to changes during the upcoming testing
              sessions.
            </p>
          </div>
        </div>

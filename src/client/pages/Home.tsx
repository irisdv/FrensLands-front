...
export default function Home() {
  ...
  useEffect(() => {
    if (account && !accountContract) {
      let accountC = new starknet.Account(
        AccountAbi as Abi,
        account,
        starknet.Provider
      );
  ...
  const BalanceNFTValue = useMemo(() => {
    console.log("CHECK THIS MEMO", fetchBalanceNFTResult);
    if (fetchBalanceNFTResult && fetchBalanceNFTResult.length > 0) {
      ...
      console.log("CHECK THIS MEMO 2", balance, account);
  ...
  useEffect(() => {
    if (settingUp) {
      var data = activeNotifications.filter(
        (transactions) =>
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="home-s2 py-5 selectDisable"
          id="roadmap"
          ref={scrollRef}
        >
          <div className="relative">
            ...
            <div className="flex flex-row justify-center inline-block mx-auto">
              <img
                src="resources/front/Gif_Community.gif"
                className="mt-16 roadmapGif"
              />
              <div className="grid">
                <div
                  className="lineWTopS"
              ...
              <div className="" style={{ marginLeft: "-20px" }}>
                ...
                >
                  <p>
                    Testing sessions of the game with early adopters. We gather
                    feedback from our community and build our game features and
                    economy accordingly.
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-row justify-center inline-block mx-auto">
              ...
              <div className="grid">
                <div
                  className="lineWxs"
                  style={{ transform: "rotate(180deg)", marginTop: "-11px" }}
                ></div>
                <div
                  className="lineWTop"
                  style={{ transform: "rotate(180deg)" }}

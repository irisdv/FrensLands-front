...
- **coal plant** 21 */}
      <div className="absolute" style={{ bottom: "60px", right: "0px", display: `${displayNature ? "block" : "none"}`, zIndex: "1" }}>
        <div className="flex flex-row justify-center inline-block">
          {level >= (buildingInfo[16].level as number) ?
          ...
          {level >= (buildingInfo[18].level as number) ?
          ...
          {level >= (buildingInfo[19].level as number) ?
          ...
          {level >= (buildingInfo[17].level as number) ?
          ...
          {level >= (buildingInfo[21].level as number) ?
          ...
          {level >= (buildingInfo[25].level as number) ?
          ...
          {level >= (buildingInfo[26].level as number) ?
...
- **agriculture/biology lab (cure disease, unlock new farms and updates, etc 24 */}
      <div className="absolute" style={{ bottom: "60px", right: "0px", display: `${displaySecurity ? "block" : "none"}` }}>
        <div className="flex flex-row justify-center inline-block">
          ...
          {level >= (buildingInfo[23].level as number) ?
          ...
          {level >= (buildingInfo[24].level as number) ?
...
- **swimming pool** 13 */}
      <div className="absolute" style={{ bottom: "60px", right: "0px", display: `${displayEntertainment ? "block" : "none"}` }}>
        <div className="flex flex-row justify-center inline-block">
          ...
          {level >= (buildingInfo[12].level as number) ?
          ...
          {level >= (buildingInfo[13].level as number) ?
          ...
          {level >= (buildingInfo[14].level as number) ?
...
- **hotels** 6 */} 
      <div className="absolute" style={{ bottom: "60px", right: "0px", display: `${displayHousing ? "block" : "none"}` }}>
        <div className="flex flex-row justify-center inline-block">
        {level >= (buildingInfo[4].level as number) ?
          ...
          {level >= (buildingInfo[5].level as number) ?
          ...
          {level >= (buildingInfo[6].level as number) ?
      ...
      <div className="absolute" style={{ bottom: "60px", right: "0px", display: `${displayShop ? "block" : "none"}` }}>
        <div className="flex flex-row justify-center inline-block">
          {level >= (buildingInfo[7].level as number) ?
          ...
          {level >= (buildingInfo[8].level as number) ?
          ...
          {level >= (buildingInfo[9].level as number) ?
          ...
          {level >= (buildingInfo[15].level as number) ?
          ...
          {level >= (buildingInfo[10].level as number) ?

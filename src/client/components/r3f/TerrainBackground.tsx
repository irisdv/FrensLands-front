...
export const TerrainBackground = (props : any) => {

    const textureLoader = useMemo(() => {
        const textObj = new TextureLoader().load("resources/textures/Water_Tile.png");
    ...
    return(
    <>
        <mesh position={[21, -0.2, 9]} name="terrainBackgroundGeometry" rotation={[-Math.PI * 0.5, 0, 0]}>

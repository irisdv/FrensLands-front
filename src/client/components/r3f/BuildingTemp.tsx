...
import { TextureLoader, RepeatWrapping, NearestFilter, PlaneGeometry, Vector2, Vector3 } from "three";
...
export const BuildingTemp = (props : any)=> {
    const { type, name, rightBuildingType, textArrRef, spaceValid, position } = props
    ...
    const textureLoader0 = useMemo(() => {
        let textObj;
        if (exists("resources/textures/"+ redText +"_nogrid_"+worldType.toString()+".png"))
        {
            textObj = new TextureLoader().load("resources/textures/"+ redText +"_nogrid_"+worldType.toString()+".png");
        }
        else
        {
            textObj = new TextureLoader().load("resources/textures/"+ redText +"_nogrid_0.png");
        }

        var textureType = new Vector2();
    ...
    const textureLoader1 = useMemo(() => {
        let textObj;
        if (exists("resources/textures/"+ greenText +"_nogrid_"+worldType.toString()+".png"))
        {
            textObj = new TextureLoader().load("resources/textures/"+ greenText +"_nogrid_"+worldType.toString()+".png");
        }
        else
        {
            textObj = new TextureLoader().load("resources/textures/"+ greenText +"_nogrid_0.png");
        }
